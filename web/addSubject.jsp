<%-- 
    Document   : addSubject
    Created on : Mar 24, 2022, 10:07:17 PM
    Author     : PC
--%>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-header-title">
                                            <h4 class="card-title">
                                                <a href="subject.jsp" class="card-header-link">
                                                    Subject Table
                                                </a>
                                            </h4>
                                        ...
                                        Here is the table for add new Subject
                                        </p>
                                    </div>
                                    <form action="AddSubjectServlet" method="post">
                                        <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input name="subId" type="text" class="form-control" id="exampleInputId" placeholder="ID">
                                                </div>    
                                                <div class="form-group">
                                                    <label for="exampleInputTitle">Title</label>
                                                    <input name="subTitle" type="text" class="form-control" id="exampleInputTitle" placeholder="Title">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputName">Name</label>
                                                    <input name="subName" type="text" class="form-control" id="exampleInputName" placeholder="Name">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputImage">Image</label>
                                                    <textarea name="subImage" class="form-control" id="exampleInputImage" rows="4"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputDate">Create Date</label>
                                                    <input name="subDate" type="text" class="form-control" id="exampleInputDate" name="date">                                       
                                                </div>
                                                 <div class="form-group">
                                                    <label for="exampleCateSubjectId">Category Subject ID</label>
                                                    <select name="categorySubjectId" class="form-control" rows="4">
                                                        <c:set var="listCateSubject" value="${requestScope.LIST_CATE_NEWS}"/>
                                                        <c:forEach items="${listCateSubject}" var="o">
                                                            <option value="${o.id}">
                                                                ${o.name}
                                                            </option>
                                                        </c:forEach>

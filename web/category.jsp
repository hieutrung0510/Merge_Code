                        ...
                        <div class="category-tag">
                              <ul class="category-list">
                                <li class="category-item ">
                                    <a href="CategoryServlet" class="category-link category-item-active">BOOK</a>
                                </li>
                                <li class="category-item">
                                    <a href="CategoryNewsServlet" class="category-link">NEWS</a>
                                </li>
                                ...
                                <div class="card strpied-tabled-with-hover">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-item">
                                            <a href="LoadSubjectIdToAddServlet" class="btn btn-success" target="_blank"><i class="fa-solid fa-circle-plus"></i> <span>Add New</span></a>
                                        </div>
                                    </div>
                                    <div class="card-body table-full-width table-responsive">
                                        <c:set var="list" value="${requestScope.LIST_CATE_BOOK}"/>
                                        <c:if test="${not empty list}">
                                        <table class="table table-hover table-striped table-action-cate-book">
                                            <thead>
                                            <th>No.</th>
                                            <th>ID</th>
                                            <th>Name</th>
                                            ...
                                            <tbody>
                                            <c:forEach items="${list}" var="listCateBook" varStatus="counter">
                                                <tr>
                                                    <td>
                                                        ${counter.count}
                                                    </td>
                                                   ...
                                                   <td>
                                                        ${listCateBook.subjectId}
                                                    </td>
                                                    <td>
                                                        <a href="editcateBook.jsp" class="icon-crud" target="_blank" title="Edit"><i class="fa-solid fa-pen-to-square" data-toggle="tooltip" title="Edit"></i></a>

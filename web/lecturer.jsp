                                ...
                                <div class="card strpied-tabled-with-hover">
                                    <div class="card-header ">
                                        ...
                                        <div class="card-header-item">
                                            <a href="LoadCategorySubjectToAddServlet" class="btn btn-success"><i class="fa-solid fa-circle-plus"></i> <span>Add New</span></a>
                                        </div>
                                    </div>
                                        ...
                                        <tbody>
                                            <c:forEach items="${list}" var="listLecturer" varStatus="counter">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editLecturer.jsp" class="icon-crud" title="Edit"><i class="fa-solid fa-pen-to-square" data-toggle="tooltip" title="Edit"></i></a>

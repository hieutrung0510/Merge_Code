<%-- 
    Document   : book
    Created on : Mar 24, 2022, 9:54:41 PM
    Author     : PC
--%>
                                ...
                                <div class="card strpied-tabled-with-hover">
                                    <div class="card-header ">
                                        ...
                                        <div class="card-header-item">
                                            <a href="LoadCateBookIdToAddServlet" class="btn btn-success" ><i class="fa-solid fa-circle-plus"></i> <span>Add New</span></a>
                                        </div>
                                    </div>
                                    <div class="card-body table-full-width table-responsive">
                                        ...
                                        <c:if test="${not empty list}">
                                            <table class="table table-hover table-striped">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${list}" var="listBook" varStatus="counter">
                                                    <form action="updateBook">                                     
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="loadBook?bid=${listBook.id}" class="icon-crud"  title="Edit"><i class="fa-solid fa-pen-to-square" data-toggle="tooltip" title="Edit"></i></a>
                                                                <a href="deleteBook?bid=${listBook.id}" class="icon-crud" ><i class="fa-solid fa-square-minus" data-toggle="tooltip" title="Delete"></i></a>
                                                            </td>
                                                      </tr>
                                                    </form>
                                                    </c:forEach>

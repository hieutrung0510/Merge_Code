<%-- 
    Document   : news
    Created on : Mar 24, 2022, 9:53:59 PM
    Author     : PC
--%>
                                ...
                                <div class="card strpied-tabled-with-hover">
                                    <div class="card-header ">
                                        ...
                                        <div class="card-header-item">
                                            <a href="LoadCategoryNewsIdToAddServlet" class="btn btn-success"><i class="fa-solid fa-circle-plus"></i> <span>Add New</span></a>
                                        </div>
                                    </div>
                                    <div class="card-body table-full-width table-responsive">
                                    <c:set var="list" value="${requestScope.LIST_NEW}"/>
                                    <c:if test="${not empty list}">
                                        ...
                                        <tbody>
                                            <c:forEach items="${list}" var="listNews" varStatus="counter">
                                                <tr>
                                                    <td>
                                                        ${counter.count}
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="loadNews?nid=${listNews.id}" class="icon-crud" title="Edit"><i class="fa-solid fa-pen-to-square" data-toggle="tooltip" title="Edit"></i></a>
                                                        <a href="deleteNews?nid=${listNews.id}" class="icon-crud" ><i class="fa-solid fa-square-minus" data-toggle="tooltip" title="Delete"></i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>

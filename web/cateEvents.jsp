<%-- 
    Document   : cateEvents
    Created on : Apr 3, 2022, 11:16:12 PM
    Author     : PC
--%>
                        ...
                        <div class="category-tag">
                            <ul class="category-list">
                                ...
                                <li class="category-item category-item-no-border">
                                    <a href="CategoryEventsServlet" class="category-link category-item-active">EVENTS</a>
                                </li>
                            </ul>
                        </div>           
                        <div class="row" id="cate-events">
                            <div class="col-md-12">
                                <div class="card strpied-tabled-with-hover">
                                    <div class="card-header ">
                                        ...
                                        <div class="card-header-item">
                                            <a href="addcateEvents.jsp" class="btn btn-success" target="_blank"><i class="fa-solid fa-circle-plus"></i> <span>Add New</span></a>
                                        </div>
                                    </div>
                                    <div class="card-body table-full-width table-responsive">
                                        ...
                                        <table class="table table-hover table-striped table-action-cate">
                                            ...
                                            <tbody>
                                                <c:forEach items="${list}" var="listCateEvents" varStatus="counter">
                                                <tr>
                                                    <td>
                                                        ${counter.count}
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="editcateEvents.jsp" class="icon-crud" target="_blank" title="Edit"><i class="fa-solid fa-pen-to-square" data-toggle="tooltip" title="Edit"></i></a>

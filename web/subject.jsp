<%-- 
    Document   : subject
    Created on : Mar 24, 2022, 9:53:41 PM
    Author     : PC
--%>
                                ...
                                <div class="card strpied-tabled-with-hover">
                                    <div class="card-header">
                                        ...
                                        <div class="search-box">
                                            <button class="btn-search" name="SearchSubject" value="Search">
                                                <i class="fas fa-search"></i>
                                            </button>
                                            <input type="text" class="input-search" placeholder="Search...">
                                        </div>
                                        <div class="card-header-item">
                                            <a href="addSubject.jsp" class="btn btn-success" ><i class="fa-solid fa-circle-plus"></i> <span>Add New</span></a>
                                        </div>
                                    </div>
                                    <div class="card-body table-full-width table-responsive">
                                        <c:set var="list" value="${requestScope.LIST_SUBJECT}"/>
                                        <c:if test="${not empty list}">
                                            <table class="table table-hover table-striped ">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${list}" var="listSubject" varStatus="counter">
                                                        <tr>
                                                            <td>
                                                                ${counter.count}
                                                                .</td>
                                                            ...
                                                            <td>
                                                                <a href="loadSubject?sid=${listSubject.id}" class="icon-crud"  title="Edit"><i class="fa-solid fa-pen-to-square" data-toggle="tooltip" title="Edit"></i></a>
                                                            ...
                                                            <div class="modal-content">
                                                                <form action="">
                                                                    ...
                                                                    <div class="modal-body">					
                                                                        <p>You can not delete this Records!</p>
                                                                    </div>

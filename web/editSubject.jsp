<%-- 
    ...
    Created on : Mar 24, 2022, 10:15:01 PM
    Author     : PC
--%>
                                    ...
                                    <div class="card-header-title">
                                        ...
                                        <div class="navbar-brand-icon">
                                         ...
                                         <h4 class="card-title-add">
                                            <a href="editSubject.jsp" class="card-header-link">
                                                Edit Subject
                                            </a>
                                          </h4>
                                      </div>
                                      <p class="card-description">
                                        Here is the table for edit Subject
                                      </p>
                                  </div>
                                  <div class="card-body">
                                      <c:set var="detailSub" value="${requestScope.DETAIL_SUBJECT_ID}"/>
                                    <form class="forms-sample">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="exampleInputImage" rows="4"></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="exampleDesc" rows="4"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleUrl">URL</label>
                                            <textarea class="form-control" id="exampleUrl" rows="4"></textarea>
                                        </div>
